...
public class ResumoMensagem {
	...
	/**
	 * Método criado somente para facilitar e agilizar o exemplo com jasper reports
	 * @return
	 */
	public Date getDataPostagem() {
		return (postadoEm!=null)?Date.from(postadoEm.atZone(ZoneId.systemDefault()).toInstant()):null;
	}
